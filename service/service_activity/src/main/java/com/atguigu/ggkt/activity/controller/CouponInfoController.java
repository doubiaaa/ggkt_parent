...
public class CouponInfoController {
    ...
    public Result index(
        ...
        IPage<CouponUse> paheModel = couponInfoService.selectCouponUsePage(pageParam, couponUseQueryVo);


        return Result.success(paheModel);
    }
